## Purpose
Allow consultants to record the date a touchpoint interaction actually occurred, independent of when it was logged. Supports backdating for interactions that were not logged immediately.
