## Purpose
Provide a tabbed home screen with a team KPI strip, team-wide open proposals, overdue task alerts, personal worklist, stale proposal alerts, and team alert widgets — all visible to every authenticated user.
