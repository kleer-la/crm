## Purpose
Provide a modal dialog experience for creating tasks directly from entity show pages (customers, prospects, proposals), keeping the user in context without a full page navigation.
